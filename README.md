...
|--------|----------|--------------|
| [listmanager.user.js](https://raw.githubusercontent.com/choujar/campaign-userscripts/main/listmanager.user.js) | List Manager | UX improvements (pointer cursor on name fields, SMS template manager) |
