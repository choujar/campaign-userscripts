...
The election has now been called! We need people to hand out 'How to Vote' cards at polling booths across [electorate] ([suburb]) on election day (21st of March). If you are able to help I can roster you on at a time and place that suits.`;
    ...
    function injectButton() {
        ...
        // Check if THIS heading already has our button
    ...
    function injectVersionBadge() {
        ...
        // Check if THIS topbar already has our badge
        ...
        badge.href = 'https://raw.githubusercontent.com/choujar/campaign-userscripts/main/listmanager.user.js?cb=' + Date.now();
        badge.target = '_blank';
        badge.rel = 'noopener';
