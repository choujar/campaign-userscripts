...
The election has now been called! We need people to hand out 'How to Vote' cards at polling booths across [electorate] ([suburb]) on election day (21st of March). If you are able to help I can roster you on at a time and place that suits.`;
    ...
    if (IS_ROCKET) {
        ...
        const CONFIRMATION_TEMPLATE_BODY = `Hi [their name], a friendly reminder from the Greens that you're on a booth tomorrow at [shifts]. A Greens t-shirt (if you requested one), How-to-Vote cards and great vibes will be there for you. Don't forget to vote yourself too!\n\nOne more thing: double your impact! Other parties are out in force and we need to make sure voters see the Greens everywhere. If you know someone who could spare even an hour on a booth tomorrow, please send me their name and number (with consent) or share mine: 0434 331 085 ([your name]). Thank you!`;
